...
/* This filter, when turned on in the JerseyRestApplicationConfig class, will enforce a user name and password (Basic Authentication) on
 * EVERY Rest request (GET, POST, PUT, DELETE).
 */
@PreMatching
public class AuthorizationFilter implements ContainerRequestFilter {
	...
	public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        // You can write the user service as an exercise.  Given the account name, it looks up the account in the database and returns it as an object.
        // Then we can verify that the user name and password in the REST request match our database.
